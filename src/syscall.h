...
static const syscall_t table[] = {
    ...
    {"rt_sigprocmask", NUM, NUM, CONST_KERNEL_SIGSET_T_P, KERNEL_SIGSET_T_P,
     NUM, 0, 0},
    ...
    {"nanosleep", NUM, CONST_STRUCT_TIMESPEC_P, STRUCT_TIMESPEC_P, 0, 0, 0, 0},
    {"getitimer", NUM, NUM, STRUCT_ITIMERVAL_P, 0, 0, 0, 0},
    {"alarm", UNSIGNED, UNSIGNED, 0, 0, 0, 0, 0},
    {"setitimer", NUM, NUM, CONST_STRUCT_ITIMERVAL_P, STRUCT_ITIMERVAL_P, 0, 0,
     0},
    ...
    {"sendto", NUM, NUM, CONST_VOID_P, NUM, NUM, CONST_STRUCT_SOCKADDR_P,
     SOCKLEN_T},
    ...
    {"sched_setscheduler", NUM, NUM, NUM, CONST_STRUCT_SCHED_PARAM_P, 0, 0, 0},
    ...
    {"settimeofday", NUM, CONST_STRUCT_TIMEVAL_P, CONST_STRUCT_TIMEZONE_P, 0, 0,
     0, 0},
    ...
    {"nfsservctl", NUM, NUM, STRUCT_NFSCTL_ARG_P, UNION_NFSCTL_RES_P, 0, 0, 0},
    ...
    {"io_getevents", NUM, AIO_CONTEXT_T, NUM, NUM, STRUCT_IO_EVENT_P,
     STRUCT_TIMESPEC_P, 0},
    {"io_submit", NUM, AIO_CONTEXT_T, NUM, STRUCT_IOCB_P, 0, 0, 0},
    {"io_cancel", NUM, AIO_CONTEXT_T, STRUCT_IOCB_P, STRUCT_IO_EVENT_P, 0, 0,
     0},
    ...
    {"semtimedop", NUM, NUM, STRUCT_SEMBUF_P, NUM, CONST_STRUCT_TIMESPEC_P, 0,
     0},
    {"fadvise64", 0, 0, 0, 0, 0, 0, 0},
    {"timer_create", NUM, CLOCKID_T, STRUCT_SIGEVENT_P, TIMER_T_P, 0, 0, 0},
    {"timer_settime", NUM, TIMER_T, NUM, CONST_STRUCT_ITIMERSPEC_P,
    ...
    {"clock_nanosleep", NUM, CLOCKID_T, NUM, CONST_STRUCT_TIMESPEC_P,
    ...
    {"mbind", NUM, VOID_P, UNSIGNED, NUM, CONST_UNSIGNED_P, UNSIGNED, UNSIGNED},
    ...
    {"mq_timedsend", NUM, MQD_T, STRING, NUM, UNSIGNED, CONST_STRUCT_TIMESPEC_P,
     0},
    {"mq_timedreceive", NUM, MQD_T, STRING, NUM, UNSIGNED_P,
     CONST_STRUCT_TIMESPEC_P, 0},
    {"mq_notify", NUM, MQD_T, CONST_STRUCT_SIGEVENT_P, 0, 0, 0, 0},
    {"mq_getsetattr", NUM, MQD_T, STRUCT_MQ_ATTR_P, STRUCT_MQ_ATTR_P, 0, 0, 0},
    {"kexec_load", NUM, UNSIGNED, UNSIGNED, STRUCT_KEXEC_SEGMENT_P, UNSIGNED, 0,
     0},
    {"waitid", NUM, IDTYPE_T, ID_T, SIGINFO_T_P, NUM, 0, 0},
    {"add_key", KEY_SERIAL_T, STRING, STRING, CONST_VOID_P, NUM, KEY_SERIAL_T,
     0},
    ...
    {"migrate_pages", NUM, NUM, UNSIGNED, CONST_UNSIGNED_P, CONST_UNSIGNED_P, 0,
     0},
    ...
    {"ppoll", NUM, STRUCT_POLLFD_P, UNSIGNED, CONST_STRUCT_TIMESPEC_P,
    ...
    {"epoll_pwait", NUM, NUM, STRUCT_EPOLL_EVENT_P, NUM, NUM, CONST_SIGSET_T_P,
     0},
    ...
    {"timerfd_settime", NUM, NUM, NUM, CONST_STRUCT_ITIMERSPEC_P,
     STRUCT_ITIMERSPEC_P, 0, 0},
    ...
    {"perf_event_open", NUM, STRUCT_PERF_EVENT_ATTR_P, NUM, NUM, NUM, UNSIGNED,
     0},
    {"recvmmsg", NUM, NUM, STRUCT_MMSGHDR_P, UNSIGNED, UNSIGNED,
     STRUCT_TIMESPEC_P, 0},
    {"fanotify_init", NUM, UNSIGNED, UNSIGNED, 0, 0, 0, 0},
    {"fanotify_mark", NUM, NUM, UNSIGNED, UNUM64_T, NUM, STRING, 0},
    {"prlimit64", 0, 0, 0, 0, 0, 0, 0},
    {"name_to_handle_at", NUM, NUM, STRING, STRUCT_FILE_HANDLE_P, NUM_P, NUM,
     0},
    ...
    {"process_vm_readv", NUM, NUM, CONST_STRUCT_IOVEC_P, UNSIGNED,
     CONST_STRUCT_IOVEC_P, UNSIGNED, UNSIGNED},
    {"process_vm_writev", NUM, NUM, CONST_STRUCT_IOVEC_P, UNSIGNED,
     CONST_STRUCT_IOVEC_P, UNSIGNED, UNSIGNED},
    ...
    {"sched_getattr", NUM, NUM, STRUCT_SCHED_ATTR_P, UNSIGNED, UNSIGNED, 0, 0},
